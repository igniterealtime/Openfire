...
public class ScramSha1SaslServer extends ScramSaslServer {
     ...
     */
    public ScramSha1SaslServer(final boolean isPlusMechanism, final Map<String, ?> props, @Nonnull final Set<String> availableMechanismsForSession, @Nonnull final Set<String> availableChannelBindingTypesForSession)
    {
