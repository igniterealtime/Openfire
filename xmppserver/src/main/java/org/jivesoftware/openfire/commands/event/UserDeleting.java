...
public class UserDeleting extends AdHocCommand {
    ...
    public String getDefaultLabel() {
        return LocaleUtils.getLocalizedString("commands.event.userdeleting.label");
    }
    ...
    public void execute(@Nonnull SessionData sessionData, Element command) {
        ...
        try {
            ...
            note.setText(LocaleUtils.getLocalizedString("commands.event.userdeleting.note.username-required", preferredLocale));
            return;
        }
    ...
    protected void addStageInformation(@Nonnull final SessionData data, Element command) {
        ...
        form.setTitle(LocaleUtils.getLocalizedString("commands.event.userdeleting.form.title", preferredLocale));
        form.addInstruction(LocaleUtils.getLocalizedString("commands.event.userdeleting.form.instruction", preferredLocale));
        ...
        field.setLabel(LocaleUtils.getLocalizedString("commands.event.userdeleting.form.field.username.label", preferredLocale));
