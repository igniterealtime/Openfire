...
public class ScramSha1SaslServer extends ScramSaslServer {
     ...
     */
    public ScramSha1SaslServer(final boolean isPlusMechanism, final Map<String, ?> props, @Nonnull final Set<String> availableMechanismsForSession)
    {
     ...
     */
    @VisibleForTesting
    ScramSha1SaslServer(final boolean isPlusMechanism, final Map<String, ?> props, final ChannelBindingProviderManager channelBindingProviderManager, @Nonnull final Set<String> availableMechanismsForSession)
    {
