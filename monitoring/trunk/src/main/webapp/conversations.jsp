...
<html>
    <head>
        ...
        <script src="/plugins/monitoring2/dwr/engine.js" type="text/javascript" ></script>
        <script src="/plugins/monitoring2/dwr/util.js" type="text/javascript" ></script>
        <script src="/plugins/monitoring2/dwr/interface/conversations.js" type="text/javascript"></script>
    </head>
    <body>
