...
/**
 * Unit tests that verify the implementation of {@link HybridUserPropertyProvider}
 *
 * @author Guus der Kinderen, guus@goodbytes.nl
 */
public class HybridUserPropertyProviderTest
{
    @BeforeAll
    ...
    public void unsetProperties() {
        JiveGlobals.deleteProperty(HybridUserPropertyProvider.PRIMARY_PROVIDER.getKey());
        JiveGlobals.deleteProperty(HybridUserPropertyProvider.SECONDARY_PROVIDER.getKey());
        JiveGlobals.deleteProperty(HybridUserPropertyProvider.TERTIARY_PROVIDER.getKey());
    }
    ...
    {
        // Setup test fixture.
        HybridUserPropertyProvider.PRIMARY_PROVIDER.setValue(TestUserPropertyProvider.NoUserProvider.class);
        HybridUserPropertyProvider.SECONDARY_PROVIDER.setValue(TestUserPropertyProvider.JaneUserProvider.class);
        HybridUserPropertyProvider.TERTIARY_PROVIDER.setValue(TestUserPropertyProvider.JohnUserProvider.class);
        final HybridUserPropertyProvider provider = new HybridUserPropertyProvider();
