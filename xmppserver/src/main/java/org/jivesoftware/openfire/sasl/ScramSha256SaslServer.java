...
public class ScramSha256SaslServer extends ScramSaslServer {
     ...
     */
    public static final String HMAC_ALGORITHM_NAME = "HmacSHA256";
    ...
    /**
     * Stores a server-side secret used when handling authentication attempts for non-existing users in SCRAM-SHA-256 (-PLUS).
     *
    ...
    static final SystemProperty<String> SERVER_SECRET_NONEXISTENT_USERS = SystemProperty.Builder.ofType(String.class)
        .setKey("sasl.scram-sha-256.server-secret.nonexistent-users")
        .setEncrypted(true)
    ...
    public static final SystemProperty<Integer> ITERATION_COUNT = SystemProperty.Builder.ofType(Integer.class)
        .setKey("sasl.scram-sha-256.iteration-count")
     ...
     */
    public ScramSha256SaslServer(final boolean isPlusMechanism, final Map<String, ?> props, @Nonnull final Set<String> availableMechanismsForSession)
    {
     ...
     */
    @VisibleForTesting
    ScramSha256SaslServer(final boolean isPlusMechanism, final Map<String, ?> props, final ChannelBindingProviderManager channelBindingProviderManager, @Nonnull final Set<String> availableMechanismsForSession)
    {
