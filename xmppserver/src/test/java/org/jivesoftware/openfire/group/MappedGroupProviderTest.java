...
/**
 * Unit tests that verify the implementation of {@link MappedGroupProvider}
 *
 * @author Guus der Kinderen, guus@goodbytes.nl
 */
public class MappedGroupProviderTest
{
    @BeforeAll
    ...
    public void unsetProperties() {
        JiveGlobals.deleteProperty(MappedGroupProvider.PROPERTY_MAPPER_CLASSNAME);
    }
    ...
    {
        // Setup test fixture.
        JiveGlobals.setProperty(MappedGroupProvider.PROPERTY_MAPPER_CLASSNAME, TestGroupProviderMapper.class.getName());
        final MappedGroupProvider provider = new MappedGroupProvider();
    ...
    /**
     * Verifies that a group named 'little-endians' is returned.
     */
    @Test
    ...
    /**
     * Verifies that a group named 'big-endians' is returned.
     */
    @Test
    ...
    /**
     * Verifies that an exception is thrown when a new group is being created, using a group name that is not unique.
     */
    @Test()
