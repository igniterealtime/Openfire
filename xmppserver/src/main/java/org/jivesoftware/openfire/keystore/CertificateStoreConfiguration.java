...
public class CertificateStoreConfiguration
{
    ...
    @Override
    @SuppressWarnings("lgtm[java/equals-on-arrays]") // For this particular instance, what LGTM warns against is exactly what the intended behavior is: ignore content of the array.
