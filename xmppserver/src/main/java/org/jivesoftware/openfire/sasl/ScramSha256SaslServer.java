...
public class ScramSha256SaslServer extends ScramSaslServer {
     ...
     */
    public ScramSha256SaslServer(final boolean isPlusMechanism, final Map<String, ?> props, @Nonnull final Set<String> availableMechanismsForSession, @Nonnull final Set<String> availableChannelBindingTypesForSession)
    {
