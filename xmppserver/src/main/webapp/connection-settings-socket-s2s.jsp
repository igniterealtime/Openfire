...
<form action="connection-settings-socket-s2s.jsp" method="post">
    ...
    <admin:contentBox title="${boxtitle}">
        ...
        <table>
            <tr>
                <td colspan="2"><input type="checkbox" name="plaintext-enabled" id="plaintext-enabled" ${plaintextConfiguration.enabled ? 'checked' : ''}/><label for="plaintext-enabled"><fmt:message key="server2server.settings.label_enable"/></label></td>
            </tr>
    ...
    <admin:contentBox title="${directtlsboxtitle}">
        ...
        <table>
            <tr>
                <td colspan="2"><input type="checkbox" name="directtls-enabled" id="directtls-enabled" ${directtlsConfiguration.enabled ? 'checked' : ''}/><label for="directtls-enabled"><fmt:message key="ssl.settings.server.directtls.label_enable"/></label></td>
            </tr>
