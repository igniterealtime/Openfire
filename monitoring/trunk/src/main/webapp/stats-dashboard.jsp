                                           ...
                                           if (lConversations.size() > i) {
                                               ...
                                               if (conversation.getRoom() == null) {
                                                   ...
                                                   /*participantNames = LocaleUtils.getLocalizedString(
                                                           "archive.group_conversation", MonitoringConstants.NAME, Arrays.asList(
                                                           "<a href='../../muc-room-occupants.jsp?roomJID=" +
                                                                   URLEncoder.encode(conversation.getRoom().toBareJID(),
                                                                           "UTF-8") + "'>", "</a>"));*/

                                                   participantNames = LocaleUtils.getLocalizedString("dashboard.group_conversation", MonitoringConstants.NAME);
                                                   participantNames += "<br/>";
