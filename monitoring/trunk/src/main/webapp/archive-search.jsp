...
<%
    ...
    String anyText = LocaleUtils.getLocalizedString("archive.settings.any", MonitoringConstants.NAME);
    ...
    <table>
        ...
        <tr>
            <td>
                ...
                LocaleUtils.getLocalizedString("archive.search.participants.any", MonitoringConstants.NAME) %>" class="textfield"/>
            </td>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" id="startDate" name="startDate" size="13"
                       ...
                       LocaleUtils.getLocalizedString("archive.search.daterange.any", MonitoringConstants.NAME)%>" class="textfield"/><br/>
