...
public class OccupantRemovedTask implements ClusterTask<Void>
{
    ...
    public OccupantRemovedTask(@Nonnull final String subdomain, @Nonnull final String roomName, @Nonnull final String nickname, @Nonnull final JID realJID, @Nonnull final NodeID originator) {
