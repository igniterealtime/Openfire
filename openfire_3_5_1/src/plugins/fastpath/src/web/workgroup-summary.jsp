...
<% if(mucServer.isRoomCreationRestricted()){ %>
    <div class="warning">
        Fastpath needs Group Conference rooms to be created on the server without restriction. Please enable Group Conference permissions <a href="/muc-create-permission.jsp">here</a>.
    </div>
...
%>
    <tr class="c1">
      ...
      <table>
        ...
        <img src="images/bullet-green-14x14.gif" width="14" height="14" border="0" title="Workgroup is currently open, active and accepting requests."/>
        </td><td nowrap>Open</td>
            <%   } else if (workgroup.getStatus() == Workgroup.Status.READY) { %>
        <img src="images/bullet-yellow-14x14.gif" width="14" height="14" border="0" title="Workgroup is currently ready to open when a member is available."/>
        </td><td nowrap>Waiting for member</td>
                <%   } else { %>
        <img src="images/bullet-red-14x14.gif" width="14" height="14" border="0" title="Workgroup is currently closed."/>
        </td><td nowrap>Closed</td>
        <%   } %>
        </tr></table>
      </td>
