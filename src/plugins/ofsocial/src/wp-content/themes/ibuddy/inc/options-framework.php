...
function optionsframework_page() {
    ...
    <?php screen_icon( 'ibuddy' ); ?>
    <h2 class="nav-tab-wrapper">
        <?php echo optionsframework_tabs(); ?>
    </h2>
	<h3 id="ibuddy-doc">Need help? Check out the theme <a href="<?php echo get_template_directory_uri() . '/documentation/'; ?>" target="_blank">Documentation</a>.</h3>
	<h3 id="ibuddy-thank">You wanna say thanks, please consider making a <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=L46CFL4B4UWSJ&lc=US&item_name=Ayman%20Al%20Zarrad&no_note=0&cn=Add%20special%20instructions%20to%20seller%3a&no_shipping=2&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted" target="_blank">Donation</a>.</h3>
