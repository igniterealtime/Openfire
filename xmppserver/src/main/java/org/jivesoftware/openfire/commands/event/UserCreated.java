...
public class UserCreated extends AdHocCommand {
    ...
    public String getDefaultLabel() {
        return LocaleUtils.getLocalizedString("commands.event.usercreated.label");
    }
    ...
    public void execute(@Nonnull SessionData sessionData, Element command) {
        ...
        try {
            ...
            note.setText(LocaleUtils.getLocalizedString("commands.event.usercreated.note.username-required", preferredLocale));
            return;
        }
        ...
        try {
            ...
            note.addAttribute("type", "error");
            note.setText(LocaleUtils.getLocalizedString("commands.event.usercreated.note.user-does-not-exist", preferredLocale));
        }
    ...
    protected void addStageInformation(@Nonnull final SessionData data, Element command) {
        ...
        form.setTitle(LocaleUtils.getLocalizedString("commands.event.usercreated.form.title", preferredLocale));
        form.addInstruction(LocaleUtils.getLocalizedString("commands.event.usercreated.form.instruction", preferredLocale));
        ...
        field.setLabel(LocaleUtils.getLocalizedString("commands.event.usercreated.form.field.username.label", preferredLocale));
