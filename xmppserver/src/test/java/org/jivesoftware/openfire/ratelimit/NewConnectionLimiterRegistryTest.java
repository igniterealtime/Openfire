...
public class NewConnectionLimiterRegistryTest {
    ...
    public void tearDown() {
        NewConnectionLimiterRegistry.C2S_ENABLED.setValue(false); // Manually set these to trigger listeners.
        NewConnectionLimiterRegistry.S2S_ENABLED.setValue(false);
