...
public class ScramSha1SaslServerTest
{
    ...
    public void testSuccess() throws Exception
    {
        ...
        authFactory.when(() -> AuthFactory.getStoredKey(any())).thenReturn(StringUtils.hash(hardCodedClientKey, "SHA-1"));
        authFactory.when(() -> AuthFactory.getServerKey(any())).thenReturn(hardCodedServerKey);
        ...
        try {
            ...
            assertEquals(serverSignature, StringUtils.decodeBase32(new String(serverFinalMessage, StandardCharsets.UTF_8).substring(2)));
