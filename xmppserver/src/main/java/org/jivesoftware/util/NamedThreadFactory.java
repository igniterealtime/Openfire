 ...
 *
 * An instance will either create new Threads or use a delegate Thread Factory.
 *
 * When a new thread is generated, the name of the generated thread is replaced by concatenation of the provided thread
 * name prefix (which is another argument of the constructor) and a sequence number. Sequence numbers are guaranteed to
...
public class NamedThreadFactory implements ThreadFactory
{
    ...
    {
        final String name = threadNamePrefix + threadNumber.getAndIncrement();
