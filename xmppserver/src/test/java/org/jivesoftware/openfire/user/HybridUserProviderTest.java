...
/**
 * Unit tests that verify the implementation of {@link HybridUserProvider}
 *
 * @author Guus der Kinderen, guus@goodbytes.nl
 */
public class HybridUserProviderTest
{
    @BeforeAll
    ...
    public void unsetProperties() {
        JiveGlobals.deleteProperty(HybridUserProvider.PRIMARY_PROVIDER.getKey());
        JiveGlobals.deleteProperty(HybridUserProvider.SECONDARY_PROVIDER.getKey());
        JiveGlobals.deleteProperty(HybridUserProvider.TERTIARY_PROVIDER.getKey());
    }
    ...
    {
        // Setup test fixture.
        HybridUserProvider.PRIMARY_PROVIDER.setValue(TestUserProvider.NoUserProvider.class);
        HybridUserProvider.SECONDARY_PROVIDER.setValue(TestUserProvider.JaneUserProvider.class);
        HybridUserProvider.TERTIARY_PROVIDER.setValue(TestUserProvider.JohnUserProvider.class);
        final HybridUserProvider provider = new HybridUserProvider();
    ...
    /**
     * Verifies that a user named 'jane' is returned (from the secondary provider).
     */
    @Test
    ...
    /**
     * Verifies that a user named 'john' is returned (from the tertiary provider).
     */
    @Test
