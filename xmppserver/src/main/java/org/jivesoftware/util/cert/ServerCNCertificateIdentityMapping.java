...
/**
 * Server Certificate identity mapping that uses the CommonName as the
 * identity credentials and provides possibility to add optional prefix and suffix
 *
 */
public class ServerCNCertificateIdentityMapping extends AbstractCNCertificateIdentityMapping {

    public ServerCNCertificateIdentityMapping() {
        SystemProperty<String> cnPattern = SystemProperty.Builder.ofType(String.class)
                .setKey("provider.serverCnIdentity.pattern")
        ...
        SystemProperty<String> cnPrefix = SystemProperty.Builder.ofType(String.class)
                .setKey("provider.serverCnIdentity.prefix")
                .setDefaultValue("")
                .setDynamic(true)
        ...
        SystemProperty<String> cnSuffix = SystemProperty.Builder.ofType(String.class)
                .setKey("provider.serverCnIdentity.suffix")
                .setDefaultValue("")
                .setDynamic(true)
                .addListener(this::setCnSuffix)
                .build();
    ...
    @Override
    public String name() {
        return "Server Common Name Mapping";
    }
